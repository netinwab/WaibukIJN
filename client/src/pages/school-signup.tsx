          ...
          <CardContent className="space-y-4">
            <Alert className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-2xl">
              <AlertDescription className="text-blue-50" >
                Your request will be reviewed. You will receive an email notification in 3-5 business days.
              </AlertDescription>
            </Alert>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {currentStep === 1 && (
              <div className="space-y-4">
                ...
                <div>
                  <Label className="text-sm font-medium text-white">Founding Year</Label><Label className="text-sm font-medium text-red-500"> *</Label>
                  <Input
                    type="number"
