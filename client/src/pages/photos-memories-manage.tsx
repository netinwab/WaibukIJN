...
export default function PhotosMemoriesManage() {
  ...
  // Update memory title mutation
  const updateMemoryTitleMutation = useMutation({
    mutationFn: async ({ memoryId, title }: { memoryId: string; title: string }) => {
      const user = JSON.parse(localStorage.getItem('user') || '{}');
      if (!user.id) throw new Error('Authentication required');
      ...
      if (!response.ok) {
        const error = await response.json();
        throw new Error(error.message || 'Failed to update memory title');
      }
    ...
    onSuccess: () => {
      toast({
        title: "Title updated",
        description: "Memory title has been updated successfully."
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 relative overflow-hidden">
      ...
      <header className="bg-white/10 backdrop-blur-lg border-b border-white/20 shadow-2xl relative">
        ...
        <div className="max-w-screen-2xl mx-auto px-2 sm:px-4 lg:px-8 relative z-10">
          ...
          <Card className="bg-blue-500/20 backdrop-blur-lg border border-blue-400/40 shadow-2xl">
            <CardContent className="p-3 sm:p-4">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                ...
                <Button
                  onClick={() => {
                    const uploadUrl = `${window.location.origin}/memory-upload`;
              ...
              <div className="mt-3 p-2 bg-white/10 rounded-lg">
                <code className="text-xs text-blue-200 break-all">
                  {window.location.origin}/memory-upload
                </code>
              </div>
                  ...
                  <DialogContent className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-2xl max-w-lg w-[95vw] sm:w-[90vw] mx-auto">
                    ...
                    <div className="space-y-4">
                      <p className="text-sm text-blue-50">
                        Create a time-limited link for external users to upload photos to your yearbook.
                      </p>
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                                    <FormControl>
                                      <SelectTrigger data-testid="select-public-category">
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <Select onValueChange={field.onChange} value={field.value || "24"}>
                                    <FormControl>
                                      <SelectTrigger data-testid="select-validity-period">
                    ...
                    <div key={memory.id} className="w-full relative">
                      {memory.mediaType === 'image' ? (
                        <div className="relative">
                          ...
                          />
                          <div className="absolute inset-0 bg-black bg-opacity-0 hover:bg-opacity-80 transition-opacity flex flex-col justify-between p-2 rounded-lg">
                            <div className="flex justify-end gap-1 opacity-0 hover:opacity-100 transition-opacity">
                              <Button
                                size="sm"
                                variant="secondary"
                        ...
                        >
                          ...
                          />
                          <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-80 transition-opacity flex flex-col justify-between p-2 rounded-lg">
      ...
      <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
        <DialogContent className="max-w-md bg-white/10 backdrop-blur-lg border border-white/20 shadow-2xl">
          <DialogHeader>
            <DialogTitle className="text-white">Edit Memory Title</DialogTitle>
          </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end space-x-2 pt-4">
                ...
                <Button
                  ...
                  onClick={() => {
                    if (editTitle.trim() && editTitle !== editMemory.title) {
                  ...
                  disabled={!editTitle.trim() || editTitle === editMemory.title}
