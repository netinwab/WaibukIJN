...
import { CURRENT_YEAR, MIN_FOUNDING_YEAR } from "@shared/constants";
...
export default function ViewerDashboard() {
  ...
  const handleMemoryUpload = async () => {
    if (!selectedFile || !linkInfo) return;
  ...
  const handleMultipleMemoryUpload = async () => {
    if (multipleUploadForm.files.length === 0 || !linkInfo) return;
                ...
                <div className="flex items-center justify-center space-x-4 p-3 bg-white/5 border border-white/10 rounded-lg">
                  ...
                  <div className="flex items-center space-x-2">
                    <Button
                      ...
                      className={uploadMode === 'single' ? 'bg-yellow-500 text-black' : 'text-white border-white/20'}
                    ...
                    <Button
                      ...
                      className={uploadMode === 'multiple' ? 'bg-yellow-500 text-black' : 'text-white border-white/20'}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      <Button
                        ...
                        disabled={multipleUploadForm.files.length === 0 || multipleUploadForm.files.some(f => !f.title.trim())}
                        className="bg-green-500 hover:bg-green-600 text-white"
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {isEditingPhone ? (
                ...
                <p className="text-white" data-testid="text-phone-number">
            ...
            <div className="border-t border-white/20 pt-4">
              <Label className="text-sm font-medium text-white/70 mb-3 block">Privacy Settings</Label>
              <div className={`flex items-center justify-between p-3 rounded-lg ${
                user?.phoneNumber ? 'bg-white/10' : 'bg-white/5'
              }`}>
                <div className="flex-1">
                  <p className={`text-sm font-medium ${
                    user?.phoneNumber ? 'text-white' : 'text-white/70'
                  }`}>Show phone number to alumni</p>
                  <p className={`text-xs ${
                    user?.phoneNumber ? 'text-white/60' : 'text-white/40'
                  }`}>
                    {user?.phoneNumber 
        ...
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-1 gap-4 mb-6 sm:grid-cols-2">
            ...
            {Array.from({ length: maxAlumniBadges - alumniBadges.length }).map((_, index) => (
              <Card key={`empty-${index}`} className="border-2 border-dashed border-white/30 bg-white/5 backdrop-blur-lg">
          ...
          {alumniBadges.length > 0 && (
            <div className="mt-4 p-3 bg-blue-900/20 backdrop-blur-lg border border-blue-300/20 rounded text-sm text-blue-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div>
                ...
                >
                  ...
                  <SelectContent className="bg-white/60 backdrop-blur-lg border border-white/20">
              ...
              <div>
                <Label className="text-white"htmlFor="graduation-year">Graduation Year</Label>
                <Select 
                ...
                >
                  ...
                  <SelectContent className="bg-white/60 backdrop-blur-lg border border-white/20 text-black">
            ...
            {selectedAlumniSchool && (
              <div className="relative max-w-md">
                ...
                <Input
                  ...
                  className="pl-10 pr-4 py-2 w-full bg-white/10 backdrop-blur-lg border border-white/20 text-white placeholder:text-white"
                />
              </div>
            )}
          </CardContent>
              ...
              {filteredClassmates.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                  {filteredClassmates.map((student) => (
                    <Card key={student.id} className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-2xl hover:shadow-lg transition-shadow">
                      <CardContent className="p-6">
                          ...
                          <div className="space-y-3 border-t border-gray-100 pt-4">
                            ...
                            {(student as any).email && (
                              <div className="flex items-start space-x-2">
                                <Mail className="h-4 w-4 text-white/40 mt-0.5 flex-shrink-0" />
                                <div className="flex-1 min-w-0">
                                  <p className="text-xs text-white/60 font-medium">Email</p>
                                  <p className="text-sm text-white truncate">{(student as any).email}</p>
                                </div>
                              </div>
                            )}
                            ...
                            <div className="flex items-start space-x-2">
                              ...
                              <div className="flex-1 min-w-0">
                                <p className="text-xs text-white/60 font-medium">Mobile</p>
                                {(student as any).phoneNumber && (student as any).showPhoneToAlumni !== false ? (
                                  <p className="text-sm text-white">{(student as any).phoneNumber}</p>
                                ) : (student as any).phoneNumber && (student as any).showPhoneToAlumni === false ? (
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 relative overflow-hidden">
      ...
      {/* Navigation Tabs - Cool Modern Design */}
      <div className="bg-white/10 backdrop-blur-lg border-b border-white/20 shadow-lg relative z-10">
          ...
          <div className="flex gap-2 py-4 overflow-x-auto scrollbar-hide"
            ...
            <button
              ...
              className={`px-4 sm:px-6 py-3 text-sm font-medium rounded-xl flex items-center space-x-2 whitespace-nowrap transition-all duration-300 transform min-w-fit ${
                activeTab === "home" 
                  ? "bg-gradient-to-r from-blue-500 to-cyan-500 text-white shadow-lg scale-105 shadow-blue-500/25" 
            ...
            <button
              ...
              className={`px-4 sm:px-6 py-3 text-sm font-medium rounded-xl flex items-center space-x-2 whitespace-nowrap transition-all duration-300 transform min-w-fit ${
                activeTab === "memory-upload" 
                  ? "bg-gradient-to-r from-yellow-500 to-orange-500 text-white shadow-lg scale-105 shadow-yellow-500/25" 
                  : "bg-white/10 text-blue-100 hover:bg-white/20 hover:text-white hover:scale-102"
              }`}
              data-testid="tab-memory-upload"
            >
              <Upload className="h-4 w-4 sm:h-4 sm:w-4" />
              <span className="hidden xs:inline">Memory Upload</span>
            </button>
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-6 sm:py-8 relative z-10">
        ...
        <div className="mb-8 bg-white/10 backdrop-blur-lg rounded-2xl p-4 sm:p-6 border border-white/20 shadow-2xl">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-blue-200 mt-1 text-sm sm:text-lg">
                {activeTab === "home" ? "Browse school memories and events" : 
                 ...
                 activeTab === "memory-upload" ? "Upload memories with special school codes" :
