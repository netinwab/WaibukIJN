  ...
  const renderSecurityTab = () => {
    return (
      <div className="space-y-4 sm:space-y-6 max-w-6xl">
        ...
        {/* Security Settings Placeholder - Can be expanded */}
        <Card className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-2xl">
          <CardHeader className="p-4 sm:p-6">
            <CardTitle className="text-lg sm:text-xl flex items-center text-white">
          ...
          <CardContent className="p-4 sm:p-6 pt-0">
            <div className="space-y-4">
              ...
              <div className="p-4 bg-white/5 rounded-lg border border-white/10">
                <h3 className="text-white font-medium mb-2">Change School Code</h3>
                <p className="text-white/60 text-sm mb-3">Update your school access code</p>
                <Button variant="outline" size="sm" className="text-white border-white/20" disabled>
                  Coming Soon
                </Button>
              </div>
